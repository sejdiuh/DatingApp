...
export class PhotoEditorComponent implements OnInit {
  ...
  initiliazeUploader() {
    this.uploader = new FileUploader({
       url: this.baseUrl + 'users/' + this.authService.decodetToken.nameid + '/photos',
  ...
  setMainPhoto(photo: Photo) {
    this.userService.setMainPhoto(this.authService.decodetToken.nameid, photo.id).subscribe(() => {
  ...
  deletePhoto(id: number) {
      this.alertify.confirm('Are you sure you want to delete this photo?', () => {
        this.userService.deletePhoto(this.authService.decodetToken.nameid, id).subscribe(() => {
